...
Cursor Table::getCursor(string conditionColumnName, BinaryOperator binaryOperator, int consitionValue)
{
    Cursor cursor(this->tableName, -1, conditionColumnName, binaryOperator, value);
